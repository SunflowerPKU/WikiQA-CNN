    ...
    for i, fname in enumerate([trainfname, devfname, testfname]):
        ...
        with open(fname, "rb") as f:
            for line in f:  
                ...
                feat = []
                #count：获取在问题和答案中同时出现且不是stopwords的单词数；weighted_count：单词的idf值
...
if __name__=="__main__":    
    ...
    parser.add_argument("--ques_col", type=int, default=1, help="column of question, default is 1")
    parser.add_argument("--ans_col", type=int, default=5, help="column of answer, default is 5")
    parser.add_argument("--lab_col", type=int, default=6, help="column of label, default is 6")
